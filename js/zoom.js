+ function($) {
    ...
    Zoom.prototype.zoomImage = function() {
        ...
        img.src = ($(this._targetImage).attr('src-full')) ? $(this._targetImage).attr('src-full') : $(this._targetImage).attr('src');
    }
    ...
    Zoom.prototype._zoomOriginal = function() {
        ...
        if( $(this._targetImage).attr('src-full') ){
           
           $(this._targetImage) 
                .attr('src-old', $(this._targetImage).attr('src'))
                .attr('src', $(this._targetImage).attr('src-full'))
    ...
    Zoom.prototype.dispose = function() {
        if (this._targetImageWrap && this._targetImageWrap.parentNode) {
            ...
            if( $(this._targetImage).attr('src-full') ){
                ...
                $(this._targetImage)
                    .attr('src', $(this._targetImage).attr('src-old'))
                    .removeAttr('src-old')
            }
