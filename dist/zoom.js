...
+function ($) {
  ...
  Zoom.prototype.zoomImage = function () {
    ...
    img.onload = function () {
      _this._fullHeight = Number(img.height);
      _this._fullWidth = Number(img.width);
      _this._offset = $(_this._targetImage).offset();
      _this._zoomOriginal();
    ...
    bigger.onload = function () {
      if (target.dataset.action !== 'zoom-out' || !_this._$body.hasClass('zoom-overlay-open')) return;
      target.dataset.source = true;
      target.src = full;
      _this._fullHeight = Number(bigger.height);
      _this._fullWidth = Number(bigger.width);
      _this._calculateZoom();
      _this._triggerAnimation();
    };
